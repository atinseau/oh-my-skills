...
2. Write `.forge/features/<slug>.md` using `skills/forge/entities/feature.md` (schema + blank). Target 15-30 lines. Optionally include `paths_involved: [<touched file paths>]` in frontmatter — not mandatory for features, but helpful for cross-referencing.
